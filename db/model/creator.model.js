...
import ShipDao from "../dao/ship.dao.js";
...
class CreatorModel {
    constructor({id, name, relation, links, profession} = {}) {
        ...
        this.relative_ships = relation || new FieldEntityArray();
    ...
    static async #buildModel(creator = {}) {
        ...
        creator.relation = await this.#getShipIdNameArrayFromDbBy(relativeShipsIdArray);
        return new CreatorModel(creator);
    }
    ...
    static async #getShipIdNameArrayFromDbBy(shipIdArray = []) {
        let idArray = [];
