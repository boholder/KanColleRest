...
class ShipModel {
    ...
    constructor(ship = {}) {
        ...
        this.additional_disable_item_types = ship.additional_disable_item_types || [];
    ...
    static async #assembleModelWithParts(ship) {
        ...
        ship.additional_disable_item_types = await
            FieldEntityArray.buildModelFromIdArray(ship.additional_disable_item_types, EquipmentTypeDao);
